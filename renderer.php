...
class core_course_renderer extends plugin_renderer_base {
    ...
    function course_section_add_cm_control($course, $section, $sectionreturn = null, $displayoptions = array()) {
        ...
        error_log(print_object($modules), 0);
    ...
    public function course_section_cm_completion($course, &$completioninfo, cm_info $mod, $displayoptions = array()) {
        ...
        if ($completionicon) {
            ...
            if ($this->page->user_is_editing()) {
                ...
                // off the JS.
                $extraclass = '';
                if (/*//BRICE : parcours conditionnels !empty($CFG->enableavailability) && */
    ...
    protected function is_cm_conditionally_hidden(cm_info $mod) {
        ...
        //BRICE : parcours conditionnels if (!empty($CFG->enableavailability)) {
            $conditionalhidden = $mod->availablefrom > time() ||
                ($mod->availableuntil && $mod->availableuntil < time()) ||
                count($mod->conditionsgrade) > 0 ||
                count($mod->conditionscompletion) > 0 ||
                count($mod->conditionsfield);
        //BRICE : parcours conditionnels }
    ...
    public function course_section_cm_availability(cm_info $mod, $displayoptions = array()) {
        ...
        if ($canviewhidden /* //BRICE : parcours conditionnels && !empty($CFG->enableavailability) */) {
